...
{
    public class HospitalBranchService:Service<HospitalBranch>,IHospitalBranchService
    {
        public HospitalBranchService(IUnitOfWork unitOfWork, IRepository<HospitalBranch> repository) : base(unitOfWork, repository)
        {
        }
    }
}
